...
const NavigationMenu = ({ links }: NavigationMenuProps) => {
  return (
    <NavigationMenuPrimitive.Root className='relative'>
      <NavigationMenuPrimitive.List className='flex flex-row rounded-lg bg-white dark:bg-gray-800 p-2 space-x-2 border border-gray-200 dark:border-gray-700 shadow-xl'>

        {links.map(({ title, href }) => (
          <NavigationMenuPrimitive.Item asChild key={title}>
